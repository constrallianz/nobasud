...
export default function ContactPage() {
  ...
  return (
    <div className="relative">
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactInfo.map((info, i) => {
              ...
              return (
                <div key={i} className="group bg-white rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900 mb-2">Réactivité garantie</h4>
                        <p className="text-gray-600">Réponse sous 24h et devis personnalisé sous 48h.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Plus de 15 ans d&apos;expérience dans le BTP au Maroc.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900 mb-2">Couverture nationale</h4>
                        <p className="text-gray-600">Intervention dans tout le Maroc avec nos équipes locales.</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      {/* Offices section */}
      <section id="bureaux" className="py-24 bg-gray-50">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {offices.map((office, i) => (
              <div key={i} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
