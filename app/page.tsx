        ...
        <div className="container relative z-10 text-center">
          <div className="max-w-5xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 leading-tight">
              Construire l&apos;<span className="text-brand-orange">avenir</span><br />
            ...
            <p className="text-lg md:text-xl lg:text-2xl mb-12 leading-relaxed max-w-4xl mx-auto">
              NOBASUD, votre partenaire de confiance pour tous vos projets de construction, 
              d&apos;infrastructure et d&apos;aménagement urbain depuis plus de 15 ans.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-6 mb-16">
              <Link href="/contact">
                <Button size="lg" className="bg-brand-orange hover:bg-brand-orange/90 text-white px-8 py-4 text-lg font-semibold shadow-xl">
                  Demander un devis
                  <ArrowRightIcon className="w-6 h-6 ml-2" />
                </Button>
              </Link>
              <Link href="/realisations">
                <Button variant="outline" size="lg" className="border-2 border-white text-white hover:bg-white hover:text-brand-blue px-8 py-4 text-lg font-semibold">
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8">
              Pourquoi choisir <span className="text-brand-orange">NOBASUD</span> ?
            </h2>
            <p className="text-xl md:text-2xl mb-16 leading-relaxed">
              Une expertise reconnue, une équipe passionnée et un engagement total pour votre satisfaction
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="text-center">
                ...
                <p className="text-lg opacity-90">Certifications ISO et respect des normes les plus strictes</p>
              </div>
              <div className="text-center">
                <UserGroupIcon className="w-16 h-16 mx-auto mb-6 text-brand-orange" />
                <h3 className="text-2xl font-bold mb-4">Équipe experte</h3>
                <p className="text-lg opacity-90">200+ professionnels qualifiés à votre service</p>
              </div>
              <div className="text-center">
                <TruckIcon className="w-16 h-16 mx-auto mb-6 text-brand-orange" />
                <h3 className="text-2xl font-bold mb-4">Délais respectés</h3>
                <p className="text-lg opacity-90">98% de nos projets livrés dans les temps</p>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link href="/contact">
                <Button size="lg" className="bg-white text-brand-blue hover:bg-white/90 px-8 py-4 text-lg font-semibold">
                  Contactez-nous
                  <ArrowRightIcon className="w-6 h-6 ml-2" />
                </Button>
              </Link>
