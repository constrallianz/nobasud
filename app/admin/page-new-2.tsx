...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <DashboardHeader variant="new-2" />

      <div className="container mx-auto px-4 py-8 space-y-8">
        <DashboardStats stats={stats} loading={loading} variant="new-2" />
        
        <QuickActions variant="new-2" />
        
        <AdminModules stats={stats} loading={loading} variant="new-2" />
      </div>
    </div>
  )
}
