...
export default function ProjectPageHeader({ totalProjects }: ProjectPageHeaderProps) {
  return (
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                Gérez les réalisations et projets en cours ({totalProjects} projet{totalProjects !== 1 ? 's' : ''})
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
