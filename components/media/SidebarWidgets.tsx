...
export default function SidebarWidgets({ latestArticles = [], popularArticles = [] }: SidebarWidgetsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2">
            <Link href="/nos-metiers" className="block p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
              <div className="text-sm font-medium text-gray-900 dark:text-white hover:text-primary">
                Nos Métiers
              </div>
            </Link>
            <Link href="/realisations" className="block p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
              <div className="text-sm font-medium text-gray-900 dark:text-white hover:text-primary">
                Nos Réalisations
              </div>
            </Link>
            <Link href="/carriere" className="block p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
              <div className="text-sm font-medium text-gray-900 dark:text-white hover:text-primary">
                Offres d'Emploi
              </div>
            </Link>
            <Link href="/contact" className="block p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
              <div className="text-sm font-medium text-gray-900 dark:text-white hover:text-primary">
                Nous Contacter
              </div>
            </Link>
      ...
      {/* Advertisement Space */}
      <Card className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700">
        <CardContent className="pt-6">
          <div className="text-center">
            ...
            <div className="bg-gray-300 dark:bg-gray-600 rounded-lg h-32 flex items-center justify-center">
              <span className="text-gray-500 text-sm">Espace publicitaire</span>
            </div>
          </div>
        </CardContent>
      </Card>
