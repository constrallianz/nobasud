          ...
          <div className="flex items-center justify-between mb-12 pb-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="px-4 py-2 bg-brand-blue text-white rounded-lg hover:bg-brand-orange transition-colors text-sm font-medium"
              >
                Partager
              </button>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-brand-orange hover:text-brand-blue font-medium"
              >
                Retour en haut ↑
              </button>
            </div>
