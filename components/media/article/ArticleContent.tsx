          ...
          <div className="flex items-center justify-between mb-16 pb-8 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="group relative px-6 py-3 bg-gradient-to-r from-primary to-accent text-white rounded-lg hover:shadow-lg transform hover:scale-105 transition-all duration-200 text-sm font-semibold"
              >
              ...
              <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
                ...
                <div className="flex items-center space-x-4">
                  <button
                    ...
                    className="group flex items-center px-6 py-3 bg-accent hover:bg-primary text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 hover:shadow-lg"
                  >
